    ...
    return (
        <Sider theme="light" trigger={null} collapsible collapsed={props.collapsed} style={{ height: '100vh' }}>
            ...
            <Menu>
                ...
                <MarcoRol Codigo="panel_roles_view" Componente={(
                ...
                <MarcoRol Codigo="panel_cirugias_view" Componente={(
                ...
                <MarcoRol Codigo="panel_consultas_view" Componente={(
                ...
                <MarcoRol Codigo="panel_laboratorios_view" Componente={(
                ...
                <MarcoRol Codigo="panel_clientes_view" Componente={(
